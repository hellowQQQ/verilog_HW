...
module pio_mm_interconnect_0 (
		...
		input  wire        led_ctrl_0_reset_reset_bridge_in_reset_reset,   //   led_ctrl_0_reset_reset_bridge_in_reset.reset
		...
		output wire [2:0]  led_ctrl_0_s0_address,                          //                            led_ctrl_0_s0.address
		output wire        led_ctrl_0_s0_write,                            //                                         .write
		output wire        led_ctrl_0_s0_read,                             //                                         .read
		input  wire [31:0] led_ctrl_0_s0_readdata,                         //                                         .readdata
		output wire [31:0] led_ctrl_0_s0_writedata,                        //                                         .writedata
		output wire        led_ctrl_0_s0_chipselect,                       //                                         .chipselect
	...
	wire   [31:0] led_ctrl_0_s0_agent_m0_readdata;                                    // led_ctrl_0_s0_translator:uav_readdata -> led_ctrl_0_s0_agent:m0_readdata
	wire          led_ctrl_0_s0_agent_m0_waitrequest;                                 // led_ctrl_0_s0_translator:uav_waitrequest -> led_ctrl_0_s0_agent:m0_waitrequest
	wire          led_ctrl_0_s0_agent_m0_debugaccess;                                 // led_ctrl_0_s0_agent:m0_debugaccess -> led_ctrl_0_s0_translator:uav_debugaccess
	wire   [31:0] led_ctrl_0_s0_agent_m0_address;                                     // led_ctrl_0_s0_agent:m0_address -> led_ctrl_0_s0_translator:uav_address
	wire    [3:0] led_ctrl_0_s0_agent_m0_byteenable;                                  // led_ctrl_0_s0_agent:m0_byteenable -> led_ctrl_0_s0_translator:uav_byteenable
	wire          led_ctrl_0_s0_agent_m0_read;                                        // led_ctrl_0_s0_agent:m0_read -> led_ctrl_0_s0_translator:uav_read
	wire          led_ctrl_0_s0_agent_m0_readdatavalid;                               // led_ctrl_0_s0_translator:uav_readdatavalid -> led_ctrl_0_s0_agent:m0_readdatavalid
	wire          led_ctrl_0_s0_agent_m0_lock;                                        // led_ctrl_0_s0_agent:m0_lock -> led_ctrl_0_s0_translator:uav_lock
	wire   [31:0] led_ctrl_0_s0_agent_m0_writedata;                                   // led_ctrl_0_s0_agent:m0_writedata -> led_ctrl_0_s0_translator:uav_writedata
	wire          led_ctrl_0_s0_agent_m0_write;                                       // led_ctrl_0_s0_agent:m0_write -> led_ctrl_0_s0_translator:uav_write
	wire    [2:0] led_ctrl_0_s0_agent_m0_burstcount;                                  // led_ctrl_0_s0_agent:m0_burstcount -> led_ctrl_0_s0_translator:uav_burstcount
	wire          led_ctrl_0_s0_agent_rf_source_valid;                                // led_ctrl_0_s0_agent:rf_source_valid -> led_ctrl_0_s0_agent_rsp_fifo:in_valid
	wire  [102:0] led_ctrl_0_s0_agent_rf_source_data;                                 // led_ctrl_0_s0_agent:rf_source_data -> led_ctrl_0_s0_agent_rsp_fifo:in_data
	wire          led_ctrl_0_s0_agent_rf_source_ready;                                // led_ctrl_0_s0_agent_rsp_fifo:in_ready -> led_ctrl_0_s0_agent:rf_source_ready
	wire          led_ctrl_0_s0_agent_rf_source_startofpacket;                        // led_ctrl_0_s0_agent:rf_source_startofpacket -> led_ctrl_0_s0_agent_rsp_fifo:in_startofpacket
	wire          led_ctrl_0_s0_agent_rf_source_endofpacket;                          // led_ctrl_0_s0_agent:rf_source_endofpacket -> led_ctrl_0_s0_agent_rsp_fifo:in_endofpacket
	wire          led_ctrl_0_s0_agent_rsp_fifo_out_valid;                             // led_ctrl_0_s0_agent_rsp_fifo:out_valid -> led_ctrl_0_s0_agent:rf_sink_valid
	wire  [102:0] led_ctrl_0_s0_agent_rsp_fifo_out_data;                              // led_ctrl_0_s0_agent_rsp_fifo:out_data -> led_ctrl_0_s0_agent:rf_sink_data
	wire          led_ctrl_0_s0_agent_rsp_fifo_out_ready;                             // led_ctrl_0_s0_agent:rf_sink_ready -> led_ctrl_0_s0_agent_rsp_fifo:out_ready
	wire          led_ctrl_0_s0_agent_rsp_fifo_out_startofpacket;                     // led_ctrl_0_s0_agent_rsp_fifo:out_startofpacket -> led_ctrl_0_s0_agent:rf_sink_startofpacket
	wire          led_ctrl_0_s0_agent_rsp_fifo_out_endofpacket;                       // led_ctrl_0_s0_agent_rsp_fifo:out_endofpacket -> led_ctrl_0_s0_agent:rf_sink_endofpacket
	wire          cmd_mux_src_valid;                                                  // cmd_mux:src_valid -> led_ctrl_0_s0_agent:cp_valid
	wire  [101:0] cmd_mux_src_data;                                                   // cmd_mux:src_data -> led_ctrl_0_s0_agent:cp_data
	wire          cmd_mux_src_ready;                                                  // led_ctrl_0_s0_agent:cp_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                // cmd_mux:src_channel -> led_ctrl_0_s0_agent:cp_channel
	wire          cmd_mux_src_startofpacket;                                          // cmd_mux:src_startofpacket -> led_ctrl_0_s0_agent:cp_startofpacket
	wire          cmd_mux_src_endofpacket;                                            // cmd_mux:src_endofpacket -> led_ctrl_0_s0_agent:cp_endofpacket
	...
	wire          led_ctrl_0_s0_agent_rp_valid;                                       // led_ctrl_0_s0_agent:rp_valid -> router_001:sink_valid
	wire  [101:0] led_ctrl_0_s0_agent_rp_data;                                        // led_ctrl_0_s0_agent:rp_data -> router_001:sink_data
	wire          led_ctrl_0_s0_agent_rp_ready;                                       // router_001:sink_ready -> led_ctrl_0_s0_agent:rp_ready
	wire          led_ctrl_0_s0_agent_rp_startofpacket;                               // led_ctrl_0_s0_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire          led_ctrl_0_s0_agent_rp_endofpacket;                                 // led_ctrl_0_s0_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire          led_ctrl_0_s0_agent_rdata_fifo_src_valid;                           // led_ctrl_0_s0_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] led_ctrl_0_s0_agent_rdata_fifo_src_data;                            // led_ctrl_0_s0_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire          led_ctrl_0_s0_agent_rdata_fifo_src_ready;                           // avalon_st_adapter:in_0_ready -> led_ctrl_0_s0_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_out_0_valid;                                      // avalon_st_adapter:out_0_valid -> led_ctrl_0_s0_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                                       // avalon_st_adapter:out_0_data -> led_ctrl_0_s0_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                      // led_ctrl_0_s0_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                      // avalon_st_adapter:out_0_error -> led_ctrl_0_s0_agent:rdata_fifo_sink_error
	...
	altera_merlin_master_translator #(
		...
		.reset                  (led_ctrl_0_reset_reset_bridge_in_reset_reset),                       //                     reset.reset
	...
	) led_ctrl_0_s0_translator (
		.clk                    (clk_0_clk_clk),                                //                      clk.clk
		.reset                  (led_ctrl_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (led_ctrl_0_s0_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (led_ctrl_0_s0_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (led_ctrl_0_s0_agent_m0_read),                  //                         .read
		.uav_write              (led_ctrl_0_s0_agent_m0_write),                 //                         .write
		.uav_waitrequest        (led_ctrl_0_s0_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (led_ctrl_0_s0_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (led_ctrl_0_s0_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (led_ctrl_0_s0_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (led_ctrl_0_s0_agent_m0_writedata),             //                         .writedata
		.uav_lock               (led_ctrl_0_s0_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (led_ctrl_0_s0_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (led_ctrl_0_s0_address),                        //      avalon_anti_slave_0.address
		.av_write               (led_ctrl_0_s0_write),                          //                         .write
		.av_read                (led_ctrl_0_s0_read),                           //                         .read
		.av_readdata            (led_ctrl_0_s0_readdata),                       //                         .readdata
		.av_writedata           (led_ctrl_0_s0_writedata),                      //                         .writedata
		.av_chipselect          (led_ctrl_0_s0_chipselect),                     //                         .chipselect
	...
	altera_merlin_master_agent #(
		...
		.clk                   (clk_0_clk_clk),                                                      //       clk.clk
		.reset                 (led_ctrl_0_reset_reset_bridge_in_reset_reset),                       // clk_reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (led_ctrl_0_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
		.m0_address              (led_ctrl_0_s0_agent_m0_address),                 //              m0.address
		.m0_burstcount           (led_ctrl_0_s0_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (led_ctrl_0_s0_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (led_ctrl_0_s0_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (led_ctrl_0_s0_agent_m0_lock),                    //                .lock
		.m0_readdata             (led_ctrl_0_s0_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (led_ctrl_0_s0_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (led_ctrl_0_s0_agent_m0_read),                    //                .read
		.m0_waitrequest          (led_ctrl_0_s0_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (led_ctrl_0_s0_agent_m0_writedata),               //                .writedata
		.m0_write                (led_ctrl_0_s0_agent_m0_write),                   //                .write
		.rp_endofpacket          (led_ctrl_0_s0_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (led_ctrl_0_s0_agent_rp_ready),                   //                .ready
		.rp_valid                (led_ctrl_0_s0_agent_rp_valid),                   //                .valid
		.rp_data                 (led_ctrl_0_s0_agent_rp_data),                    //                .data
		.rp_startofpacket        (led_ctrl_0_s0_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (led_ctrl_0_s0_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (led_ctrl_0_s0_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (led_ctrl_0_s0_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (led_ctrl_0_s0_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (led_ctrl_0_s0_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (led_ctrl_0_s0_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (led_ctrl_0_s0_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (led_ctrl_0_s0_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (led_ctrl_0_s0_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (led_ctrl_0_s0_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                  // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                  //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                   //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                  //                .error
		.rdata_fifo_src_ready    (led_ctrl_0_s0_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (led_ctrl_0_s0_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (led_ctrl_0_s0_agent_rdata_fifo_src_data),        //                .data
	...
	) led_ctrl_0_s0_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (led_ctrl_0_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (led_ctrl_0_s0_agent_rf_source_data),             //        in.data
		.in_valid          (led_ctrl_0_s0_agent_rf_source_valid),            //          .valid
		.in_ready          (led_ctrl_0_s0_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (led_ctrl_0_s0_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (led_ctrl_0_s0_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (led_ctrl_0_s0_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (led_ctrl_0_s0_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (led_ctrl_0_s0_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (led_ctrl_0_s0_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (led_ctrl_0_s0_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	pio_mm_interconnect_0_router_001 router_001 (
		.sink_ready         (led_ctrl_0_s0_agent_rp_ready),                 //      sink.ready
		.sink_valid         (led_ctrl_0_s0_agent_rp_valid),                 //          .valid
		.sink_data          (led_ctrl_0_s0_agent_rp_data),                  //          .data
		.sink_startofpacket (led_ctrl_0_s0_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (led_ctrl_0_s0_agent_rp_endofpacket),           //          .endofpacket
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (led_ctrl_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pio_mm_interconnect_0_router_001 router_002 (
	...
	pio_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (led_ctrl_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pio_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (led_ctrl_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pio_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (led_ctrl_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (led_ctrl_0_s0_agent_rdata_fifo_src_data),      //     in_0.data
		.in_0_valid     (led_ctrl_0_s0_agent_rdata_fifo_src_valid),     //         .valid
		.in_0_ready     (led_ctrl_0_s0_agent_rdata_fifo_src_ready),     //         .ready
